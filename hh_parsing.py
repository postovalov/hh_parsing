...
# https://www.youtube.com/watch?v=lgGkBh8IUok&feature=youtu.be
...
# base_url = "http://hh.ru/search/vacancy?L_is_autosearch=false&area=113&clusters=true&enable_snippets=true&search_period=7&text=python&page=0"
# Tyumen base_url = 'https://tyumen.hh.ru/search/vacancy?L_is_autosearch=false&area=95&clusters=true&enable_snippets=true&text=python&page=0'
# Ekb base_url = 'https://ekaterinburg.hh.ru/search/vacancy?L_is_autosearch=false&area=3&clusters=true&enable_snippets=true&text=python&page=0'
# Moscow
